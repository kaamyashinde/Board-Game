 ...
 * This action is typically used to create a penalty or setback for players
 * who land on certain tiles in the game.
 *
 * @author kaamyashinde
 * @version 1.0
 */
public class LoseTurnAction implements TileAction {
     ...
     * This is done by setting the player's skipNextTurn flag to true,
     * which will be checked during the next turn to determine if the player
     * should be skipped.
     *
