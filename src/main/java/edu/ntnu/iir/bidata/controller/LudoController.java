...
import edu.ntnu.iir.bidata.model.tile.EntryPointAction;
import edu.ntnu.iir.bidata.model.tile.SafeSpotAction;
    ...
    private void handleMoveResult(MoveResult result) {
        ...
        switch (result.type) {
            ...
            case "capture":
                ...
                break;
            default:
                LOGGER.info(currentPlayer + " moved token " + (result.tokenIndex + 1) + " to position " + result.end);
        }
